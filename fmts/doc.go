...
// 	php
// 		phpcs	(phpcs --report=emacs -q) PHP_CodeSniffer - tokenizes PHP files to detect violations of a defined coding standard! - https://github.com/squizlabs/PHP_CodeSniffer
